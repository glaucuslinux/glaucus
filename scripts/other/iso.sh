#!/usr/bin/dash -e
#$RSYNC /home/glaucus/system /home/glaucus/temporary/system/iso --delete
#mkdir -v \
...
#$RSYNC /usr/lib/syslinux/bios/isolinux.bin /home/glaucus/temporary/system/iso/isolinux --delete
#$RSYNC /usr/lib/syslinux/bios/ldlinux.c32 /home/glaucus/temporary/system/iso/isolinux --delete
#$RSYNC /usr/lib/syslinux/bios/memdisk /home/glaucus/temporary/system/iso/isolinux/kernel --delete
